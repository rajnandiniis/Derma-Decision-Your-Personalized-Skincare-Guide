...
# Header
st.set_page_config(page_title="Derma Decision", page_icon=":blossom:", layout="wide",)

# menampilkan halaman utama
st.title("Derma Decision Skin Care :sparkles:")
...
st.write(
    """
    ##### ** DermaDecision : The Skin Care Product Recommendation Application is an implementation of a Machine Learning project that can provide product recommendations tailored to your skin type and concerns. You can input your skin type, issues, and desired benefits to receive appropriate skin care product recommendations.**
    """)  
st.write('---') 
...
# pt = product type
category = first.selectbox(label='Product Category : ', options= skincare['Product Type'].unique() )
category_pt = skincare[skincare['Product Type'] == category]
